            ...
            <div>
                ...
                <div className="beid_marque">
                    <marquee className="beid_marquee">This website provides comprehensive information about B.Ed, stating that it stands for Bachelor of Education. According to NCTE, completing B.Ed is a requirement for teaching higher education in schools. B.Ed is a 2-year professional course, emphasizing theory, assignments, fieldwork, and research.</marquee>
                            ...
                            <img src="https://ttmadrid.com/wp-content/uploads/2018/06/exam-1.jpg" alt="Exam" class="beid_image"/>
                ...
                <div className="beid_bigbox">
                    ...
                    <h3 className="beid_Bachelor">Bachelor of Education(B.ED) Exam Basic Information</h3>
                        ...
                        <p className="beid_paragaph"><b>The syllabus for B.Ed entrance exams may vary slightly between different universities and institutions. However, the general syllabus often includes the following key areas:</b></p>
                        <ul className="beid_underlist">
                                <li><strong>General English and Comprehension:</strong> This section assesses the candidate's proficiency in the English language, covering grammar, vocabulary, and reading comprehension.</li>
