...
function Railways(){
    return(
        <div>
            <div className="Railway_mainBox">
                <div className="Railway_marquee">
                    ...
                    <ul className="Railway_whitelist">
                            ...
                            <li>The RRB NTPC syllabus can be found on the official website, furnishing a thorough outline for candidates preparing for the examination.</li>
                            <li>RRB Group D Syllabus and Exam Pattern</li>
            ...
            <div className="Railway_boxHeadingMain">
                    <div className="Railway_boxHeading">
                        <h2 className="Railway_boxHeading1">RRB Syllabus and Exam Pattern - RRB JE, Group D, NTPC & ALP</h2>
                    ...
                    <div className="Railaway_textbox">
                        ...
                        <table border="1" cellspacing="0" cellpadding="9" id="Railway_table">
                                ...
                                <tr>
                                    <td rowspan="3">RRB NTPC CBT – 2</td>
                                    <td>General Awareness</td>
                                    <td>50</td>
                                </tr>
                                <tr>
                                ...
                                <h4 className="Railway_line">The detailed section-wise RRB NTPC Syllabus is given below:</h4>
                                                                    <div class="table-container">
                                        <h2>RRB NTPC Syllabus</h2>
                                        <table>
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <td>Number System</td>
                                            <td>Puzzle</td>
                                            <td>National and International Current Affairs</td>
                                            </tr>
                                            <tr>
                                            <td>Decimal</td>
                                            ...
                                            <td>Common Abbreviations</td>
                                            </tr>
                                            <tr>
                                            <td>Mensuration</td>
                                            <td>Statement and Conclusion</td>
                                            <td>Important Government Organizations</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                            <td>Time and Work</td>
                                            <td>Direction Test</td>
                                            <td>Inventions</td>
                                            </tr>
                                            <tr>
                                            <td>Simple and Compound Interest</td>
                                            <td>Decision Making</td>
                                            <td>Famous Personalities (India & International)</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <td>Alphanumeric Series</td>
                                            <td>Banking History</td>
                                            </tr>
                                            <tr>
                                            <td>Geometry and Trigonometry</td>
                                            <td>Venn Diagrams</td>
                                            <td>Banking Terms and Organizations</td>
                                            </tr>
                                            <tr>
                                            <td>Elementary Statistics</td>
                                            <td></td>
                                            <td>Important days & dates</td>
                                            </tr>
                                            <tr>
                                            <td>Quadratic Equations</td>
                                            <td></td>
                                            <td>General & Life Science</td>
                                            </tr>
                                            <tr>
                                            <td>Simplification</td>
                                            <td></td>
                                            <td>Physical, Economical & Geographical features of India and World</td>
                                            </tr>
                                            <tr>
                                            <td>Upstream and Downstream</td>
                                            <td></td>
                                            ...
                                            <td></td>
                                            <td>Indian Art & Culture</td>
                                            </tr>
                                        </tbody>
                                        </table>
                                    </div>
                                    <div className="Railaway_text1">
                                            <h4>RRB Group D Syllabus and Exam Pattern</h4>
                                            ...
                                            <ol className="Railway_list">
                                                ...
                                                <h2>RRB Group D Exam Pattern</h2>
                                            ...
                                            <table className="Railway_table4">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <td></td>
                                                    <td>Basics of Computer Applications</td>
                                                    <td>10</td>
                                                    </tr>
                                                    <tr>
                                                    <td></td>
                                                    <td>Basics of Environment and Pollution Control</td>
                                                    <td>10</td>
                                                    </tr>
                                                    <tr>
                                                    <td></td>
                                                ...
                                                <p>RRB JE Syllabus for CBT-1</p>

                                                <table className="Railaway_text3">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <td>Analogies</td>
                                                            <td>Physics</td>
                                                            <td>India and International Current Affairs</td>
                                                            </tr>
                                                            <tr>
                                                            <td>BODMAS</td>
                                                            <td>Statement – Arguments and Assumptions</td>
                                                            <td>Chemistry</td>
                                                            ...
                                                            <td>Directions</td>
                                                            <td>Life Sciences</td>
                                                            <td>Culture and history of India including freedom struggle</td>
                                                            </tr>
                                                            <tr>
                                                            <td>Fractions</td>
                                                            <td>Analytical reasoning</td>
                                                            <td></td>
                                                            <td>Indian Polity and constitution</td>
                                                            </tr>
                                                            <tr>
                                                            <td>LCM & HCF</td>
                                                            <td>Alphabetical and Number Series</td>
                                                            <td></td>
                                                            <td>Environmental issues concerning India and the World</td>
                                                            </tr>
                                                            <tr>
                                                            <td>Ratio and Proportion</td>
                                                            ...
                                                            <td></td>
                                                            <td>Scientific and Technological Inventions</td>
                                                            </tr>
                                                            <tr>
                                                            <td>Mensuration</td>
                                                            <td>Conclusions and Decision Making</td>
                                                            <td></td>
                                                            <td>Static General Knowledge(national parks, sanctuaries, currency, state capitals, airports, etc.)</td>
                                                            </tr>
                                                            <tr>
                                                            <td>Pipes and Cisterns</td>
                                                            <td>Syllogism</td>
                                                            <td></td>
                                                            <td>Important days and Dates</td>
                                                            </tr>
                                                            <tr>
                                                            <td>Calendar and Clock</td>
                                                            <td>Blood Relations</td>
                                                            <td></td>
                                                            <td>Organisations and their Headquarters</td>
                                                            </tr>
                                                            <tr>
                                                            <td>Age Problems</td>
                                                            <td>Coding and Decoding</td>
                                                            <td></td>
                                                            <td>Important Abbreviations</td>
                                                            </tr>
                                                            <tr>
